const firebaseConfig = {
  apiKey: "AIzaSyAtfQ_0eeBS5f5cjRd5fmcSFEL0Jg1bWgE",
  authDomain: "quizapp-10-3a95e.firebaseapp.com",
  projectId: "quizapp-10-3a95e",
  storageBucket: "quizapp-10-3a95e.firebasestorage.app",
  messagingSenderId: "996607920849",
  appId: "1:996607920849:web:a4fd4619be43bc4b40d3f0"
};
// key chnge krdi
// Initialize Firebase
...
const questions = [
  ...
  {
    question: "In JS variable types are __ ",
    option1: "6",
    option2: "3",
    option3: "8",
    corrAnswer: "8",
...
const getOption = questions[index][`option${selectedOption}`];
  // Fix here: access the current question
